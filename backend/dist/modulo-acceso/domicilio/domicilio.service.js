...
let DomicilioService = class DomicilioService extends base_service_1.BaseService {
    constructor(clienteRepository) {
        super(clienteRepository);
        this.clienteRepository = clienteRepository;
    }
};
DomicilioService = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [domicilio_repository_1.DomicilioRepository])
], DomicilioService);
